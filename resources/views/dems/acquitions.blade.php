...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      @include('dems.components.navbar')
        ...
        <div class="row luxury-top-main pt-5 pb-5 d-flex align-items-center justify-content-center">
            ...
            <div class="col-md-6  col-11 order-2 luxury-in-2 d-flex align-items-end justify-content-center mt-3">
                <div class="row col-lg-12 luxury-in-2-text">
                <h6 class="" id="SUB-TEXT">ACQUISITIONS</h6>
                <h1 class="pb-lg-4 pb-2">Sell Your Business</h1>
               ...
               <h2><i class="bi bi-telephone"></i>  &nbsp;Call us </h2>
               <p>+1-800-569-2754</p>
    ...
    <!-- < src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d108852.64967372711!2d74.3243776!3d31.506432!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x391905d3e3ae6b77%3A0x157a2f53f97b67c6!2sSSL%20SOLUTIONS!5e0!3m2!1sen!2s!4v1701334520745!5m2!1sen!2s -->
                ...
                <div class="row" >
                    <div class="col-lg-6 p-3">
                        <h1 class="mt-5" style="font-size: 55px; font-weight: 700; color: white;">Book a meeting <br>
                            <span style="color: rgb(252, 194, 71);;">to get started</span></h1>
